...
namespace F18I4DABH3Gr27.Controllers
{
    public class AltAddressesController : ApiController
    {
        ...
        public async Task<IHttpActionResult> PostAltAddress(AltAddress altAddress)
        {
            ...
            return CreatedAtRoute("DefaultApi", new { id = altAddress.AltAddressId }, altAddress);
        }
        ...
        {
            return db.AltAddresses.Count(e => e.AltAddressId == id) > 0;
        }
    }
}